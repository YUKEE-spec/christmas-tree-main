        ...
        <div style={{
          ...
          <div className="tech-panel" style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '15px' }}>
              <p style={{ fontSize: '10px', letterSpacing: '2px', color: 'var(--tech-cyan)', margin: 0 }}>树形参数</p>
              <span onClick={onToggle} style={{ cursor: 'pointer', opacity: 0.8 }}>×</span>
            </div>

            {/* 颜色选择 */}
            <div style={{ marginBottom: '20px' }}>
              <p style={{ fontSize: '10px', letterSpacing: '2px', color: '#888', margin: '0 0 10px 0' }}>树影光谱</p>
              <div style={{
                display: 'grid',
                ...
                {TREE_COLOR_OPTIONS.map((color) => (
                  <button
                    ...
                    onClick={() => {
                      ...
                      // if (color.value !== 'custom') onToggle(); // 保持打开以便预览
                    }}
                    style={{
                      fontSize: '10px',
            ...
            {/* 形状选择 */}
            <div style={{ marginBottom: '20px' }}>
              <p style={{ fontSize: '10px', letterSpacing: '2px', color: '#888', margin: '0 0 10px 0' }}>树形结构</p>
            ...
            {/* 粒子数量 */}
            <div>
              <p style={{ fontSize: '10px', letterSpacing: '2px', color: '#888', margin: '0 0 10px 0' }}>粒子密度</p>
